...
export class AdminComponent implements OnInit {
  ...
  createRoom2() {
    ...
    console.log(groupInfo);
    this.httpClient.post<Userobj[]>(BACKEND_URL + '/createRoom2', groupInfo,  httpOptions)
      .subscribe((m: any) => {alert(JSON.stringify(m));});
  }
  ...
  addUserGroup2() {
    ...
    console.log(groupInfo);
    this.httpClient.post<Userobj[]>(BACKEND_URL + '/addUserGroup2', groupInfo,  httpOptions)
      .subscribe((m: any) => {alert(JSON.stringify(m));});
  }
  ...
  deleteGroup2() {
    let groupname = {'groupname': this.groupname};
    console.log(groupname);
    this.httpClient.post<Userobj[]>(BACKEND_URL + '/deleteGroup2', groupname,  httpOptions)
      .subscribe((m: any) => {alert(JSON.stringify(m));});
  }
  ...
  deleteRoom2() {
    ...
    console.log(groupInfo);
    this.httpClient.post<Userobj[]>(BACKEND_URL + '/deleteRoom2', groupInfo,  httpOptions)
      .subscribe((m: any) => {alert(JSON.stringify(m));});
  }
  ...
  removeUserGroup2() {
    ...
    console.log(groupInfo);
    this.httpClient.post<Userobj[]>(BACKEND_URL + '/removeUserGroup2', groupInfo,  httpOptions)
      .subscribe((m: any) => {alert(JSON.stringify(m));});
  }
